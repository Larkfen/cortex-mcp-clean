...
def create_mcp_lifespan(api_key: Optional[str] = None, api_key_id: Optional[str] = None, papi_client: Optional[Any] = None):
    """
    ...
    Args:
        ...
        papi_client: PAPIClient compartido para que issue/case usen la misma instancia que OpenAPI
    """
    @asynccontextmanager
...
def create_mcp_server(api_key: Optional[str] = None, api_key_id: Optional[str] = None, papi_client: Optional[Any] = None) -> FastMCP:
    """
    ...
    """
    lifespan = create_mcp_lifespan(api_key, api_key_id, papi_client)
